                ...
                <div class="card borde-0 shadow-lg my-3">
                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="">SKU</label>
                                <input value="{{ old('sku', $product->sku) }}" type="text" class="@error('name') is-invalid @enderror form-control form-control-lg" placeholder="SKU"
                                name="sku">
                                @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                name="description" col="30" rows="5"> {{ old('description', $product->description)}} </textarea>
                            </div>
